...
export const DISCIPLINES: Discipline[] = [
  ...
  { id: 'flying_trapeze',    label: 'Trapecio Volante',          category: 'Aéreo', genre: 'aerial' },
  { id: 'swinging_trapeze',  label: 'Trapecio Balancín',         category: 'Aéreo', genre: 'aerial' },
  { id: 'dance_trapeze',     label: 'Trapecio de Danza',         category: 'Aéreo', genre: 'aerial' },
  ...
  { id: 'cloud_swing',       label: 'Cloud Swing',               category: 'Aéreo', genre: 'aerial' },
  { id: 'aerial_cradle',     label: 'Cuna Aérea',                category: 'Aéreo', genre: 'aerial' },
  { id: 'korean_cradle',     label: 'Cuna Coreana',              category: 'Aéreo', genre: 'aerial' },
  { id: 'aerial_cube',       label: 'Cubo Aéreo',                category: 'Aéreo', genre: 'aerial' },
  { id: 'aerial_pole',       label: 'Pole Aéreo',                category: 'Aéreo', genre: 'aerial' },
  ...
  { id: 'hand_to_hand',       label: 'Hand to Hand',            category: 'Acrobacia de Piso', genre: 'floor' },
  { id: 'basic_scale',        label: 'Báscula',                  category: 'Acrobacia de Piso', genre: 'floor' },
  ...
  { id: 'cyr_wheel',          label: 'Rueda Cyr',                category: 'Acrobacia de Piso', genre: 'floor' },
  { id: 'german_wheel',       label: 'German Wheel',             category: 'Acrobacia de Piso', genre: 'floor' },
